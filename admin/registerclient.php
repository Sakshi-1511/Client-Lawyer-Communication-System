...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <?php
                $query = "SELECT * FROM clientsignup";
          ...
          <table class="u-table-entity u-table-entity-1">
            ...
            <thead class="u-black u-table-header u-table-header-1">
              <tr style="height: 72px;">
                ...
                <th class="u-border-1 u-border-black u-palette-1-base u-table-cell u-table-cell-2">First Name</th>
                <th class="u-border-1 u-border-black u-palette-1-base u-table-cell u-table-cell-2">Last Name</th>
               ...
               <th class="u-border-1 u-border-black u-palette-1-base u-table-cell u-table-cell-4">Password</th>
                ...
                <th class="u-border-1 u-border-black u-palette-1-base u-table-cell u-table-cell-6">Action </th>
                        ...
                        <tr style="height: 75px;">
                                ...
                                <td class="u-border-1 u-border-grey-30 u-table-cell"><?php  echo $row['Fname']; ?></td>
                                <td class="u-border-1 u-border-grey-30 u-table-cell"><?php  echo $row['Lname']; ?></td>
