...
<body>
     ...
     <nav class="navbar navbar-expand-lg sticky-top text-right" style=" background-color: rgb(19, 33, 82);">
        <div class="container-fluid">
          <a class="navbar-brand bg-light text-light" href="#">  <img src="imgs/logo1.jpg" alt="Logo" width="201" height="41" class="d-inline-block align-text-top">
          </a>
...
<div class="container">
    <div class="row">
        <div class="col-lg-6 mb-4">
            <div class="card" style="width: 18rem;">
                <img src="imgs/boy avatar image.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                  <h5 class="card-title">Kunal Wani </h5>
                  <h6 class="card-title">District Lawyer</h6>
                  <p class="card-text">Solved 100+ cases</p>
                  <a href="#" class="btn btn-primary">View Profile</a>
                  <a href="#" class="btn btn-primary">Reject Profile</a>
                </div>
              </div>
        </div>
        <div class="col-lg-6 mb-4">
            <div class="card" style="width: 18rem;">
                <img src="imgs/goal.png" class="card-img-top" alt="...">
                <div class="card-body">
                  <h5 class="card-title">Mansi Shardul</h5>
                  <h6 class="card-title">District Lawyer</h6>
                  <p class="card-text">Solved 100+ cases</p>
                  <a href="#" class="btn btn-primary">View Profile</a>
                  <a href="#" class="btn btn-primary">Reject Profile</a>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 mb-4">
				<div class="card" style="width: 18rem;">
                    <img src="imgs/graduated.png" class="card-img-top" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">Trushna Garad</h5>
                  <h6 class="card-title">District Lawyer</h6>
                      <p class="card-text">Solved 100+ cases</p>
                      <a href="#" class="btn btn-primary">View Profile</a>
                      <a href="#" class="btn btn-primary">Reject Profile</a>
			...
			<div class="col-lg-6 mb-4">
				<div class="card" style="width: 18rem;">
                    <img src="imgs/lawyer.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">Sakshi pardeshi</h5>
                  <h6 class="card-title">FDistrict Lawyer</h6>
                      <p class="card-text">Solved 100+ cases</p>
                      <a href="#" class="btn btn-primary">View Profile</a>
                      <a href="#" class="btn btn-primary">Reject Profile</a>
                    </div>
